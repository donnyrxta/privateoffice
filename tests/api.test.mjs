...
try{
  ...
  r=await request('/residences',{cookie:agentCookie,redirect:'manual'});eq(r.status,307,'portfolio route stays locked before a precise fix');eq(r.headers.get('location')?.includes('/agent/location'),true,'locked portfolio redirects to precise-location gate');
